...
class TestGridSearch(unittest.TestCase):
    ...
    def test_classify_with_best_params(self):
        ...
        assert_almost_equal(
            np.array([
                48, 48, 25, 25, 23, 8, 6, 6, 21, 45, 20, 20, 39, 19, 17, 11, 16, 16,13, 13, 21, 18, 10, 10, 14, 3, 9, 8, 7, 23, 6, 6, 5, 45, 8, 45, 21, 4, 2, 46, 1, 1, 6, 1, 0, 0, 6, 26, 41, 6, 38, 38, 37, 37, 6, 22, 27, 27, 42, 42, 10, 21, 44, 19, 6, 34, 33, 33, 45, 45, 32, 32, 31, 16, 46, 46, 16, 33, 28, 28, 6, 39, 24, 24, 14, 14, 15, 15, 18, 15, 45, 30, 12, 35
