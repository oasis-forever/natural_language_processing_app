...
class TestDialogueAgent(unittest.TestCase):
    ...
    def test_raw_tokenize_text1(self):
        ...
        self.assertEqual(['[', '初めて', 'TensorFlow', ']', '定価', '2200円', '+', '税'], self.preprocess.raw_tokenize(self.text1))

    def test_raw_tokenize_text2(self):
        self.assertEqual(['[', '初めて', 'TensorFlow', ']', '定価', '2200円', '+', '税'], self.preprocess.raw_tokenize(self.text2))

    def test_raw_tokenize_text3(self):
        self.assertEqual(['[', '初めて', 'TensorFlow', ']', '定価', '2200円', '+', '税'], self.preprocess.raw_tokenize(self.text3))
